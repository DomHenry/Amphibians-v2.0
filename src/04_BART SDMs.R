...
## Currently going to go with three times the number of occ points
...
## Use envstack_rsa to predict at national scale
map <- predict2.bart(
  sdm,
  envstack_prov,
...
# source("helper functions/write_bart_plots.R")
...
# Write rasters -----------------------------------------------------------
# source("helper functions/write_bart_rasters.R")
